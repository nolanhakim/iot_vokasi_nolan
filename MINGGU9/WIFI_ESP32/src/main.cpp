...
const char* ssid = "Bismillah Berkah2";
const char* password = "ganti1sampai8";
...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    HTTPClient http;
    String url = "http://ba7d-114-10-46-87.ngrok-free.app/api/posts"; // Ganti dengan URL ngrok yang benar
